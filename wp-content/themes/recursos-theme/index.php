...
<ol class="curtains">
	...
	<li id="marcolegal" class="section cover">      
		...
		<div id="marco-propuestas" class="marco">
			...
			<p>
				<a href="/uploads/OnePagerLGEEPA_EIA.pdf" target="_blank" title="Propuesta de modificación a la Ley General de Equilibrio Ecológico y Protección al Ambiente en materia de Evaluación de Impacto Ambiental">
	...
	<li id="ingresos" class="section cover">
		...
		<div class="controls">
			<a id="prev">Anterior</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id="next">Siguiente</a>
		</p>
		...
		<div id='map'>
			<div id='map-ui'>
				<ul>
					...
					<li><span id='g1-layer2'>&Aacute;reas Naturales Protegidas Federales</span></li>
				 ...
				 <ul class="margin20">
					<li><span id='g2-layer1'>Concesiones mineras</span></li>
					<li><span id='g2-layer2' class="active">&Aacute;reas Naturales Protegidas Federales</span></li>
	...
	<li id="publicaciones" class="section cover">
		...
		<div class="slideshow">
			<ul class="ul-publicaciones">
				...
				<li>
					<a href="http://www.fundar.org.mx/mexico/pdf/transyaccesopemex.pdf" title="Estado de la Transparencia y el Acceso a la Información en las Contrataciones de Pemex " target="_blank">
						Estado de la Transparencia y el Acceso a la Información en las Contrataciones de Pemex 
					</a>
				</li>
				<li>
					<a href="http://www.fundar.org.mx/pdfavancesyretrocesos/06.pdf" title="Ingresos Petroleros y gasto público" target="_blank">
						Ingresos Petroleros y gasto público
					</a>
				</li>
				<li>
					<a href="http://www.fundar.org.mx/secciones/publicaciones/pdf/La%20importancia%20del%20FEIP.pdf" title="La importancia del Fondo de Estabilización de Ingresos Petroleros" target="_blank">
						La importancia del Fondo de Estabilización de Ingresos Petroleros
					</a>
				</li>
				<li>
					<a href="http://www.fundar.org.mx/mexico/pdf/mecanismosdecontrol.pdf" title="Mecanismos de transparencia y rendición de cuentas de Pemex: retos y propuestas para su fortalecimiento" target="_blank">
						Mecanismos de transparencia y rendición de cuentas de Pemex: retos y propuestas para su fortalecimiento
					</a>
				</li>
				<li>
					<a href="http://www.fundar.org.mx/mexico/pdf/mineria.pdf" title="Minería, comunidades y medio ambiente. Investigaciones sobre el impacto de la inversión canadiense en México" target="_blank">
						Minería, comunidades y medio ambiente. Investigaciones sobre el impacto de la inversión canadiense en México
					</a>
				</li>
				<li>
					<a href="http://www.fundar.org.mx/secciones/publicaciones/pdf/Ingresos_Petroleros.pdf" title="Recursos Naturales e Ingresos Fiscales en México" target="_blank">
